...
CREATE TABLE IF NOT EXISTS `otterboard`.`bucketFile` (
  ...
  `bucketFile_name` VARCHAR(100) NULL,
  `bucketFile_code` VARCHAR(45) NULL,
  `user_id` INT NOT NULL,
  PRIMARY KEY (`bucketFile_id`, `user_id`),
  INDEX `fk_badgesFile_user_idx` (`user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `otterboard`.`industryFile` (
  ...
  `industryFile_name` VARCHAR(45) NULL,
  `industryFile_path` VARCHAR(45) NULL,
